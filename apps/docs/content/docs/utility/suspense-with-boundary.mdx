...
<ComponentTabs name="suspense-with-boundary-demo" />
...
<ComponentSource
	name="suspense-with-boundary"
	src="../../packages/ui-react/src/components/common/suspense-with-boundary/suspense-with-boundary.tsx"
/>
